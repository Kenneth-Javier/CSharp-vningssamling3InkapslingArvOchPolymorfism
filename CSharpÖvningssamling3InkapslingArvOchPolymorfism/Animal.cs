...
namespace CSharpÖvningssamling3InkapslingArvOchPolymorfism
{
    ...
    class Horse : Animal
    {
        ...
        public Horse(string name, double weight, double height, int age, string breed) : base(name, weight, height, age){Breed = breed;}
    ...
    class Dog : Animal
    {
        ...
        public Dog(string name, double weight, double height, int age, string size) : base(name, weight, height, age){Size = size;}
        public override string Stats(){return base.Stats() + " Size: " + Size + ""; }
        public override void DoSound(){ Console.WriteLine("Woooof! Woooof! ");}

    }
    class Hedgehog : Animal
    {
        public int Tags { get; set; }
        public Hedgehog(string name, double weight, double height, int age, int tags) : base(name, weight, height, age){Tags = tags;}
        public override string Stats(){ return base.Stats() + " ldgksdlgksdöl: " + Tags;  }
        public override void DoSound(){Console.WriteLine("eiieeeeeyyyhh! ");}
    }
    class Worm : Animal
    {
        public int Lenght { get; set; }
        public Worm(string name, double weight, double height, int age, int lenght) : base(name, weight, height, age){Lenght = lenght;}
        public override string Stats(){return base.Stats() + " lenght: " + Lenght + "cm"; }
        public override void DoSound(){Console.WriteLine("ZzZzZzZzZzZ! ");}
    }
    class Bird : Animal
    {
        ...
        public override void DoSound(){Console.WriteLine("PAKA! PAKA!! ");}
    }
    class Wolf : Animal
    {
        public double TeethSize { get; set; }
        public Wolf(string name, double weight, double height, int age, double teethSize) : base(name, weight, height, age){TeethSize = teethSize; }
        public override string Stats(){return base.Stats() + " teeth size: " + TeethSize +"cm"; }
        public override void DoSound(){Console.WriteLine("AOUUUU! AOUUUU!! ");}
    }

    class Pelican : Bird 
    {
        public double MouthVolume { get; set; }
        public Pelican(string name, double weight, double height, int age, double wingSpan, double mouthVolume) : base(name, weight, height, age, wingSpan){MouthVolume = mouthVolume;}
        public override string Stats() { return base.Stats() + ". The mounth volume: : " + MouthVolume + "L"; }
        public override void DoSound(){Console.WriteLine("PAAAAAAAAAA!! ");}
    }
    class Flamingo : Bird 
    {
        public double LegLength { get; set; }
        public Flamingo(string name, double weight, double height, int age, double wingSpan, double legLength) : base(name, weight, height, age, wingSpan){LegLength = legLength;}
        public override string Stats() { return base.Stats() + " The leg length: : " + LegLength+ "cm";}
        public override void DoSound() { Console.WriteLine("PAh PAh PAh PAh PAh ");}

    }
    class Swan : Bird 
    {
        public double NeckLength {get; set; }
        public Swan(string name, double weight, double height, int age, double wingSpan, double neckLength) : base(name, weight, height, age, wingSpan){NeckLength = neckLength;}
        public override string Stats() { return base.Stats() + " The neck length: " + NeckLength + "cm"; }
        public override void DoSound(){Console.WriteLine("HÄÄÄÄÄ! ");}
    }
    
    class Wolfman : Wolf, PersonInterface
    {
        public double Width { get; set; }
        public Wolfman(string name, double weight, double height, int age, double teethSize, double width) : 
            base(name, weight, height, age, teethSize){ Width = width; }
        public override void DoSound(){ Console.WriteLine("AOUUUU! AOUUUU!! AOUUUU!!"); }
        public void Talk(){ Console.WriteLine("Jag är en man hjälp!"); }
